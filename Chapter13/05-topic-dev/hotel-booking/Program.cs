...
namespace consumer
{
    ...
    class Program
    {
        ...
        */
        ...
        static string subscriptionName = "hotel-booking";
        ...
        static async Task Main()
        {
            ...
            async Task MessageHandler(ProcessMessageEventArgs args)
            {
                ...
                //print only hotelbooking
                booking.HotelBookings.ToList().ForEach(x => Console.WriteLine($"Hotel: {x.City} {x.CheckinDate.Date}"));
